...
>
    ...
    <html lang="en-us">
      ...
      <body>
        ...
        <div class="INDENT">
          ...
          <p>
            This page allows you to see what Tasks match up with which Encounters, and if you click on the Pokemon, it will show you a CP to IV reference chart.
          </p>
        </div>
        ...
        <div id="ByEncounter" style="display:none;">
          <xsl:apply-templates select="FieldResearch" mode="ByEncounter" />
        </div>
  ...
  <!-- #region Templates to output the tables by Encounter -->
  ...
  <!-- #endregion Templates to output the tables by Encounter -->
