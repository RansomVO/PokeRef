        ...
        <div class="INDENT">
            ...
            <li>
              ...
              <ul>
                <li style="margin:unset">
                  Sometimes there is only 1 possibility so you <span class="EMPHASIS">know</span> what it will be if you catch it.
                </li>
          ...
          <ol id="AFTER_THROW">
            <li>
              ...
              Sometimes there is only 1 possibility so you <span class="EMPHASIS">know</span> what you have, so you can stop here.
            </li>
            <li>
