    ...
    <html lang="en-us">
      ...
      <body>
        ...
        <p>
          ...
          Every time a Pokemon does a Fast move it causes the opponent a little damage <span class="EMPHASIS">AND</span> it generates some Energy, which, for your Pokemon, is indicated by a bar at the top of the screen under the Pokemon's name.
        </p>
        ...
        <p>
          ...
          Every time a Pokemon does a Charged move it causes the opponent a lot of damage <span class="EMPHASIS">BUT</span> the Pokemon can only perform the Charged Move if it has generated enough Energy by performing Fast moves, which is indicated by the bar at the top of the screen being full.
        </p>
